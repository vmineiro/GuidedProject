...
//		contentPane.add(pathInputLabel1);
//		contentPane.add(pathInputLabel2);
//		contentPane.add(pathInputField);

//		pathInputPanel.add(pathInputLabel1);
	...
	private void createWidgets() {
		...
		pathInputPanel.setLayout(new GridLayout(1,2,10,10));
		...
		buttonsPanel.setLayout(new FlowLayout(FlowLayout.CENTER, 3, 1));
